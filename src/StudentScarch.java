...
import java.awt.*;
public class StudentScarch extends JFrame implements ActionListener{
    private Container c;
    private Font f;
    private JLabel titlelable,fnlable,fnlable2,lnlable,lnlable2,phonelable,phonelable2,courselable,courselable2,paymentlable,paymentlable2,idlable,teacherlable,teacherlable2,scorelable,scorelable2,admissionlable,admissionlable2;
    private JTextField idtf;
    private JButton serchbutton,clearbutton,backbutton;
    int intflag=0;
    int intid=0;
    StudentScarch(int flag,int id){
        intflag=flag;
        intid=id;
        initComponents();
    }
    public void initComponents(){
        this.setTitle("Scerch Student");
